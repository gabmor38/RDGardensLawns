          ...
          <nav className="navbar  flex justify-content-end" style={{background: '#818C78', padding: '20px'}}>
            <div className="container text-center">
                <div className="col col-lg-1">
                  <a href="https://www.facebook.com/profile.php?id=61573539554978" target="_blank" role="button" data-bs-toggle="button">
                ...
                <div className="col">
                  <p className="text-white">Copyright &copy; RD Everterra Gardens & Lawns 2025</p>
                </div>
