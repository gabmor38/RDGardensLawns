          ...
          <div className="row row-cols-1 row-cols-sm-3 g-4">
            <div className="col">
              <div className="card h-100">
                <img src="/pic1.png" className="card-img-top card-img-fixed" alt="..."/>
            ...
            <div className="col">
              <div className="card h-100 ">
                <img src="/pic2.png" className="card-img-top card-img-fixed" alt="..."/>
                <div className="card-body" style={{borderBottom: '5px solid #818C78', borderRadius: '5px'}}>
            ...
            <div className="col">
              <div className="card h-100 ">
                <img src="/pic3.png/"className="card-img-top card-img-fixed" alt="..."/>
                <div className="card-body" style={{borderBottom: '5px solid #818C78', borderRadius: '5px'}}>
            ...
            <div className="col  mb-5">
              <div className="card h-100 ">
                <img src="/pic9.png/"className="card-img-top card-img-fixed" alt="..."/>
                <div className="card-body" style={{borderBottom: '5px solid #818C78', borderRadius: '5px'}}>
            ...
            <div className="col  mb-5">
              <div className="card h-100 ">
                <img src="/pic5.png/"className="card-img-top card-img-fixed" alt="..."/>
                <div className="card-body" style={{borderBottom: '5px solid #818C78', borderRadius: '5px'}}>
            ...
            <div className="col mb-5">
              <div className="card h-100 ">
                <img src="/pic4.png/"className="card-img-top  card-img-fixed" alt="sod" height='280px'/>
                <div className="card-body" style={{borderBottom: '5px solid #818C78', borderRadius: '5px'}}>
